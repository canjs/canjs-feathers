...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
      define(['can/util/library', 'can/model', 'feathers-websocket-client'], factory);
  } else if (typeof exports === 'object') {
      module.exports = factory(require('can/util/library'), require('can/model'), require('feathers-websocket-client'));
  } else if(typeof window !== 'undefined' && root && root.can && root.FeathersClient) {
      factory(root.can, root.can.Model, root.FeathersClient);
  }
}(this, function (can, Model, feathersClient) {
